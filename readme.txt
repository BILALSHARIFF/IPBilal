...
Project Members: Bilal shariff and Hari haran
...
13.Typing localhost/index.php should now open up the completed project.

14.All code is commented annotated for easier understanding.

Note: Internet connection is required for jquery functions to operate.

credits: Copyright ? 2015 Bilal and Hari Blood Donors 